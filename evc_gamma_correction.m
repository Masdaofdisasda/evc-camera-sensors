...
gamma(gamma <= 0.0000000001) = 0.0000000001;

corrected = input.^(gamma^-1);
...
R = brightness_corrected(1);
G = brightness_corrected(2);
B = brightness_corrected(3);
R = R .* chromaticity;
G = G .* chromaticity;
B = B .* chromaticity;
